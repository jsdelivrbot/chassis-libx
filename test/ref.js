...
//   NGNX.REF.replacer.innerHTML = 'replaced'
//   t.ok(NGNX.REF.replacer.innerHTML === 'replaced', 'Replaced innerHTML of a reference.')
//
//   t.doesNotThrow(function () {
//     NGNX.REF.replacer.donuts = 'mmm'
//   }, 'Setting inconsequential attribute does not throw error.')
//
//   NGNX.REF.replacer.innerHTML = '<div><span>yo</span><span>dude</span></div>'
//
...
//   })
//
//   NGNX.REF.replacer.find('span').forEach(function (ref) {
